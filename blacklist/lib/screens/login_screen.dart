...
class _LoginScreenState extends State<LoginScreen> {
  ...
  final _notariaController = TextEditingController(text: 'Notaría 142 - Ciudad de México');
  final _usuarioController = TextEditingController(text: 'notario.titular@notaria142cdmx.mx');
  ...
  Future<void> _submitLogin() async {
    ...
    try {
      ...
      setState(() {
        _isLoading = false;
        _errorMessage = 'No se pudo conectar con el servidor. Intente de nuevo.';
      });
    }
  }
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Row(
                          children: [
                            const Icon(Icons.token_outlined, size: 19, color: Color(0xFF4F46E5)),
                            const SizedBox(width: 8),
                            Text(
                        ...
                        text: TextSpan(
                          ...
                          children: [
                            ...
                            TextSpan(
                              ...
                              style: GoogleFonts.jetBrainsMono(fontWeight: FontWeight.w500, color: const Color(0xFF0F172A)),
                            ),
                            const TextSpan(text: ' • '),
                            TextSpan(
                              text: '55 5200 4000',
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return Flex(
          ...
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: [
            _buildSealCard(Icons.vpn_lock, 'Cifrado TLS 1.3', 'Protección de extremo a extremo en transferencias'),
            if (isWide) const SizedBox(width: 12) else const SizedBox(height: 12),
            _buildSealCard(Icons.hub, 'DOF • SAT • OFAC', 'Conexión validada con boletines oficiales'),
            if (isWide) const SizedBox(width: 12) else const SizedBox(height: 12),
            _buildSealCard(Icons.gavel, 'LFPIORPI', 'Conformidad legal para actividades vulnerables'),
          ],
        );
      },
    );
            ...
            RichText(
              text: TextSpan(
                ...
                children: [
                  ...
                  TextSpan(
                    text: 'COT-190422-MX8',
                    style: GoogleFonts.jetBrainsMono(fontWeight: FontWeight.w600, color: const Color(0xFF1E293B)),
                  ),
                ],
              ),
            ),
